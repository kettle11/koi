...
fn hook_impl(info: &panic::PanicInfo) {
    ...
    crate::libraries::eval(
        "alert(\"The application has crashed. If you'd like to report this error check the console for errors to send to the developer.     Click the page refresh button to continue. \");",
    );
}
